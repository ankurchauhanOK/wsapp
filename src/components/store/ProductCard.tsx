...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-3 flex gap-3 relative">
      <button
      ...
      <Link
        ...
        className="shrink-0"
      >
        <div className="w-20 h-20 bg-green-50 rounded-lg flex items-center justify-center overflow-hidden">
          {product.image ? (
            <Image
              src={product.image}
              alt={product.name}
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          {stock === "out_of_stock" ? null : cartItem ? (
            ...
            <Button size="sm" onClick={handleAdd} className="h-7 px-3 text-xs">
