    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {showFab && (
        <Link href="/admin/scanner/billing">
          <button className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-green-600 text-white shadow-lg flex items-center justify-center hover:bg-green-700 active:scale-95 transition-all hover:shadow-xl">
